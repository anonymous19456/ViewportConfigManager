...
3. Open GitBash and navigate to your Unreal Engine 5.5 Plugins directory using the `cd` command.
   1. Example: `cd "C:\Program Files\Epic Games\UE_5.5\Engine\Plugins"`
