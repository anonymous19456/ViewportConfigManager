...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FVpClientConfigData_Statics::NewProp_ViewMode = { "ViewMode", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FVpClientConfigData, ViewMode), Z_Construct_UEnum_Engine_EViewModeIndex, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ViewMode_MetaData), NewProp_ViewMode_MetaData) }; // 1951490823
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_ovfxc_Documents_GithubProjects_PackagedPlugins_ViewportConfigManager_5_5_VpLayoutConfig_HostProject_Plugins_VpLayoutConfig_Source_VpLayoutConfig_Private_VpLayoutConfigDataStructures_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FVpClientConfigData::StaticStruct, Z_Construct_UScriptStruct_FVpClientConfigData_Statics::NewStructOps, TEXT("VpClientConfigData"), &Z_Registration_Info_UScriptStruct_VpClientConfigData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVpClientConfigData), 1771566051U) },
		{ FVpFullLayoutData::StaticStruct, Z_Construct_UScriptStruct_FVpFullLayoutData_Statics::NewStructOps, TEXT("VpFullLayoutData"), &Z_Registration_Info_UScriptStruct_VpFullLayoutData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVpFullLayoutData), 1167964300U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ovfxc_Documents_GithubProjects_PackagedPlugins_ViewportConfigManager_5_5_VpLayoutConfig_HostProject_Plugins_VpLayoutConfig_Source_VpLayoutConfig_Private_VpLayoutConfigDataStructures_h_1474675057(TEXT("/Script/VpLayoutConfig"),
	Z_CompiledInDeferFile_FID_Users_ovfxc_Documents_GithubProjects_PackagedPlugins_ViewportConfigManager_5_5_VpLayoutConfig_HostProject_Plugins_VpLayoutConfig_Source_VpLayoutConfig_Private_VpLayoutConfigDataStructures_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ovfxc_Documents_GithubProjects_PackagedPlugins_ViewportConfigManager_5_5_VpLayoutConfig_HostProject_Plugins_VpLayoutConfig_Source_VpLayoutConfig_Private_VpLayoutConfigDataStructures_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_ovfxc_Documents_GithubProjects_PackagedPlugins_ViewportConfigManager_5_5_VpLayoutConfig_HostProject_Plugins_VpLayoutConfig_Source_VpLayoutConfig_Private_VpLayoutConfigDataStructures_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ovfxc_Documents_GithubProjects_PackagedPlugins_ViewportConfigManager_5_5_VpLayoutConfig_HostProject_Plugins_VpLayoutConfig_Source_VpLayoutConfig_Private_VpLayoutConfigDataStructures_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
